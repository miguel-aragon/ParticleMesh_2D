...
psi_x = read_fvolume('Data/PSI_X.fvol')
psi_y = read_fvolume('Data/PSI_Y.fvol')
psi_z = read_fvolume('Data/PSI_Z.fvol')
...
write_custom_gad, head, px,py,pz, vx,vy,vz, id, 'IC/IC_512_RAW.GAD'
